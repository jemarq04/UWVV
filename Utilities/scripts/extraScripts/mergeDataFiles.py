...
if __name__ == "__main__":
    ...
    parser.add_argument("channels", type=str, nargs=1, help="Comma-separated list of channels or channel shorthands.")
    parser.add_argument("input", type=str, nargs=1, help="Comma-separated list of input files. May contain wildcars.")
