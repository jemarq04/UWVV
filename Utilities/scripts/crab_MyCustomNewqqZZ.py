...
for arg in sys.argv:
    if 'Data.inputDataset2=' in arg:
        dataset = arg.split('=')[1]
dataset = "/qqZZSpecTest2018/102X_upgrade2018_realistic_v20/MINIAODSIM"
if dataset == 'dummy':
...
config.Data.userInputFiles = open('qqZZNewMClistFinal.dat').readlines()
...
if isMC:
    config.General.requestName = '_'.join([campaign_name, "qqZZSpecTestNew"])
...
config.Data.outputPrimaryDataset = "qqZZSpecTest18"
