...
void JetViewerMy::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup) {
  using namespace edm;
  evtcount++;
  Handle<JetView> jets;
  ...
  jetcount = 0;
  for (JetView::const_iterator jet = jets->begin(); jet != jets->end(); ++jet) {
    jetcount++;
    try {
      ...
      printf("%3d %7.2f %6.2f %6.2f %5d %5d %7d\n",
             ...
             jet->eta(),
             jet->phi(),
             jet->userInt("pileupJetId:fullId"),
             PUid,
             jetcount);
    } catch (...) {
      printf("%3d %7.2f %6.2f %6.2f %5d %5d %7d\n",
...
void JetViewerMy::beginJob() {}

// ------------ method called once each job just after ending the event loop  ------------
void JetViewerMy::endJob() {}

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
void JetViewerMy::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
