///////////////////////////////////////////////////////////////////////////////
//      TempCleanedJetCollectionEmbedder.cc
//
...
class TempCleanedJetCollectionEmbedder : public edm::stream::EDProducer<>
{

  public:
    explicit TempCleanedJetCollectionEmbedder(const edm::ParameterSet &iConfig);
    virtual ~TempCleanedJetCollectionEmbedder(){};
...
TempCleanedJetCollectionEmbedder::TempCleanedJetCollectionEmbedder(const edm::ParameterSet &iConfig) 
...
void TempCleanedJetCollectionEmbedder::produce(edm::Event &iEvent,
...
edm::PtrVector<pat::Jet> TempCleanedJetCollectionEmbedder::getCleanedJetCollection(edm::Event &iEvent,
    const edm::EDGetTokenT<edm::View<pat::Jet>> &jetToken,
    const reco::CompositeCandidate &initialState)
{
...
DEFINE_FWK_MODULE(TempCleanedJetCollectionEmbedder);
