    ...
    for (size_t j=i+1; j<nLeptons-2; j++){
      for (size_t k=j+1; k<nLeptons-1; k++){
        for (size_t l=k+1; l<nLeptons; l++){
          ...
          double dMZ1 = std::abs((dressedleptons[currLeptonsIdx[0]].p4()
              + dressedleptons[currLeptonsIdx[1]].p4()).M()-91.1876);
          double dMZ2 = std::abs((dressedleptons[currLeptonsIdx[2]].p4()
              + dressedleptons[currLeptonsIdx[3]].p4()).M()-91.1876);
          ...
          double z2LepPt = dressedleptons[currLeptonsIdx[2]].p4().pt()
            + dressedleptons[currLeptonsIdx[3]].p4().pt();
