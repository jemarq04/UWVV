        ...
        if stepName == "initialStateCreation":
            ...
            for chan in parseChannels("zz"):
                ...
                cleaner = cms.EDProducer(
                    ...
                    l1PtCut=cms.double(20.0),
                    l2PtCut=cms.double(10.0),
                    l3PtCut=cms.double(5.0),
                    l4PtCut=cms.double(5.0),
                    etaCut=cms.double(2.5),
                    ossfMassCut=cms.double(4.0),
                    z1MassMin=cms.double(40.0),
                    z1MassMax=cms.double(120.0),
                    z2MassMin=cms.double(4.0),
                    z2MassMax=cms.double(120.0),
                )
