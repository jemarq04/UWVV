...
cmsRun xsec_cfg.py inputFileList=.temp_inputs.dat 2>&1 | tee out_zz4l.txt
...
cmsRun xsec_cfg.py inputFileList=.temp_inputs.dat scale=0.00305851 2>&1 | tee out_ggZZ4e.txt
...
cmsRun xsec_cfg.py inputFileList=.temp_inputs.dat scale=0.00305851 2>&1 | tee out_ggZZ4m.txt
...
cmsRun xsec_cfg.py inputFileList=.temp_inputs.dat scale=0.00624157 2>&1 | tee out_ggZZ2e2m.txt
