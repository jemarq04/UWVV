...
options.register(
    ...
    VarParsing.VarParsing.multiplicity.singleton,
    VarParsing.VarParsing.varType.int,
    "1 if extra HZZ quantities like matrix element discriminators and Z kinematic refit are desired.",
)
options.register(
    "genInfo",
    0,
...
options.register(
    ...
    VarParsing.VarParsing.multiplicity.singleton,
    VarParsing.VarParsing.varType.string,
    "lepton type. Options: dressedHPFS, dressedFS, hardProcesFS, hardProcess",
)
options.register(
    "eScaleShift",
    0,
...
if (
    "RunIISpring16" in options.inputFiles[0]
    and "reHLT" not in options.inputFiles[0]
    and "withHLT" not in options.inputFiles[0]
):
