...
muonBranches = cms.PSet(
    floats=cms.PSet(
        ...
        PtErr=cms.string('? hasUserFloat("correctedPtError") ? userFloat("correctedPtError") : bestTrack.ptError'),
        # Muon corrections
    ...
    uints=cms.PSet(
        ...
        IsTight=cms.string('? hasUserInt("isTightMuon") ? userInt("isTightMuon") : 0'),
        CutBasedLoose=cms.string('? hasUserInt("CutBasedIdLoose") ? userInt("CutBasedIdLoose") : 0'),
        CutBasedMedium=cms.string('? hasUserInt("CutBasedIdMedium") ? userInt("CutBasedIdMedium") : 0'),
        CutBasedTight=cms.string('? hasUserInt("CutBasedIdTight") ? userInt("CutBasedIdTight") : 0'),
        PFIsoLoose=cms.string('? hasUserInt("PFIsoLoose") ? userInt("PFIsoLoose") : 0'),
        PFIsoMedium=cms.string('? hasUserInt("PFIsoMedium") ? userInt("PFIsoMedium") : 0'),
        PFIsoTight=cms.string('? hasUserInt("PFIsoTight") ? userInt("PFIsoTight") : 0'),
        PFIsoVTight=cms.string('? hasUserInt("PFIsoVeryTight") ? userInt("PFIsoVeryTight") : 0'),
    ),
    bools=cms.PSet(
        ...
        HighPtID=cms.string('? hasUserFloat("ZZIDPassHighPt") ? userFloat("ZZIDPassHighPt") : 0.'),
        HighPtIDNoVtx=cms.string('? hasUserFloat("ZZIDPassHighPtNoVtx") ? userFloat("ZZIDPassHighPtNoVtx") : 0.'),
        PFID=cms.string('? hasUserFloat("ZZIDPassPF") ? userFloat("ZZIDPassPF") : 0.'),
        PFIDNoVtx=cms.string('? hasUserFloat("ZZIDPassPFNoVtx") ? userFloat("ZZIDPassPFNoVtx") : 0.'),
    ),
)

muonCalibrationBranches = cms.PSet(
    floats=cms.PSet(
        PtUncorrected=cms.string('? hasUserCand("uncorrected") ? userCand("uncorrected").pt : pt'),
        PtErrUncorrected=cms.string(
            '? hasUserCand("uncorrected") ? userCand("uncorrected").bestTrack.ptError : bestTrack.ptError'
        ),
    ),
)
